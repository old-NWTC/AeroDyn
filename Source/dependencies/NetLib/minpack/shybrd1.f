      subroutine shybrd1(n,x,fvec,tol,info,wa,lwa, fcnArgs)
...
c     **********
c
c     subroutine shybrd1
c
c     the purpose of shybrd1 is to find a zero of a system of
...
c
c       subroutine shybrd1(n,x,fvec,tol,info,wa,lwa, fcnArgs)
c
c     where
c
...
c
   ...
   10    continue
      ...
      lr = (n*(n + 1))/2
      index = 6*n + lr
      call shybrd(n,x,fvec,xtol,maxfev,ml,mu,epsfcn,wa(1),mode, 
