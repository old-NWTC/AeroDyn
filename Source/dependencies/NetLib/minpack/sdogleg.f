      subroutine sdogleg(n,r,lr,diag,qtb,delta,x,wa1,wa2)
      integer n,lr
      real delta
      real r(lr),diag(n),qtb(n),x(n),wa1(n),wa2(n)
c     **********
c
c     subroutine sdogleg
c
...
c     then sdogleg expects the full upper triangle of r and
c     the first n components of (q transpose)*b.
c
c     the subroutine statement is
c
c       subroutine sdogleg(n,r,lr,diag,qtb,delta,x,wa1,wa2)
c
c     where
c
...
c     finally, calculate the point along the sdogleg
c     at which the quadratic is minimized.
c
      bnorm = senorm(n,qtb)
...
c
  ...
  140 continue
      return
c
c     last card of subroutine sdogleg.
c
      end
