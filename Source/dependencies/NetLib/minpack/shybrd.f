      subroutine shybrd(n,x,fvec,xtol,maxfev,ml,mu,epsfcn,diag,
...
c
c       subroutine shybrd(fcn,n,x,fvec,xtol,maxfev,ml,mu,epsfcn,
c                        diag,mode,factor,nprint,info,nfev,fjac,
c                        ldfjac,r,lr,qtf,wa1,wa2,wa3,wa4, fcnArgs)
c
c     where
c
...
c       user-supplied ...... fcn
c
c       minpack-supplied ... sdogleg,spmpar,senorm,sfdjac1,
c                            sqform,sqrfac,sr1mpyq,sr1updt
c
...
c
      iflag = 1
      call BEMT_CoupledErrFn(x, fvec, iflag, fcnArgs)
...
c
         iflag = 2
         call sfdjac1(n,x,fvec,fjac,ldfjac,iflag,ml,mu,epsfcn,wa1,
     +               wa2, fcnArgs)
         nfev = nfev + msum
         if (iflag .lt. 0) go to 300
c
...
c
         call sqrfac(n,n,fjac,ldfjac,.false.,iwa,1,wa1,wa2,wa3)
c
...
c
         call sqform(n,n,fjac,ldfjac,wa1)
c
...
c
            call sdogleg(n,r,lr,diag,qtf,delta,wa1,wa2,wa3)
c
...
c
            call sr1updt(n,n,r,lr,wa1,wa2,wa3,sing)
            call sr1mpyq(n,n,fjac,ldfjac,wa2,wa3)
            call sr1mpyq(1,n,qtf,1,wa2,wa3)
c
...
c
      ...
      iflag = 0
      if (nprint .gt. 0) call BEMT_CoupledErrFn(x, fvec, iflag, fcnArgs)
         !call fcn(n,x,fvec,iflag)
      return
c
